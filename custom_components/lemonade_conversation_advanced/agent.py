...
class LemonadeConversationEntity(ConversationEntity):
    """Lemonade Conversation Advanced conversation entity with multi-provider support."""

    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        """Initialize the Lemonade Conversation Advanced conversation entity."""
        super().__init__()
        ...
        # Entity attributes
        profile_name = entry.data.get("profile_name", "Lemonade Conversation Advanced")
        ...
        self._attr_device_info = dr.DeviceInfo(
            ...
            manufacturer="Lemonade Conversation Advanced",
        ...
        _LOGGER.info(
            "Lemonade Conversation Advanced Agent initialized - Server: %s, Model: %s, MCP Port: %d, URL: %s",
            self.server_type,
            self.model_name,
            self.mcp_port,
    ...
    def mcp_port(self) -> int:
        ...
        return self._get_shared_setting(CONF_LEMONADE_PORT, DEFAULT_MCP_PORT)
    ...
    def profile_name(self) -> str:
        """Return profile name."""
        return self.entry.data.get(CONF_PROFILE_NAME, "Lemonade Conversation Advanced")
    ...
    def _get_auth_headers(self) -> Dict[str, str]:
        ...
        if self.server_type == SERVER_TYPE_OPENAI:
            ...
            return {
                ...
                "HTTP-Referer": "https://github.com/mike-nott/lemonade-conversation-advanced",
